...
static const u8 tws_res_type_tbl[TWS_RES_MAX] =
{
    ...
    [TWS_RES_ANC_OFF]       = RES_TYPE_MP3,
    [TWS_RES_ANC_ON]        = RES_TYPE_MP3,
#if SWETZ
    [TWS_RES_SW_PAIRING]    = TWS_RES_TYPE,
    [TWS_RES_SW_CONNECTED]  = TWS_RES_TYPE,
    [TWS_RES_SW_DISCONNEC]  = TWS_RES_TYPE,
    [TWS_RES_SW_MAX_VOL]    = TWS_RES_TYPE,
    [TWS_RES_SW_MUSIC_MODE] = TWS_RES_TYPE,
    [TWS_RES_SW_GAME_MODE]  = TWS_RES_TYPE,
    [TWS_RES_SW_ANC_ON]     = RES_TYPE_MP3,
    [TWS_RES_SW_ANC_OFF]    = RES_TYPE_MP3,
    [TWS_RES_ANC_OPEN]      = RES_TYPE_MP3,
    [TWS_RES_SW_LOW_BATTERY]    = RES_TYPE_MP3,
    [TWS_RES_SW_FIND_EAR]    = RES_TYPE_WAV,
    [TWS_RES_SW_POWER_ON]  = RES_TYPE_MP3,
#endif
...
void tws_res_get_addr(u32 index, u32 *addr, u32 *len)
{
    ...
    case TWS_RES_PAIRING:
        ...
        *len = RES_LEN_PAIRING;
        break;
    case TWS_RES_ANC_ON:
        *addr = RES_BUF_ZH_ANCON_MP3;
        *len = RES_LEN_ZH_ANCON_MP3;
        break;
    case TWS_RES_ANC_OFF:
        *addr = RES_BUF_ZH_ANCOFF_MP3;
        *len = RES_LEN_ZH_ANCOFF_MP3;
        break;
#if SWETZ
    case TWS_RES_SW_PAIRING:
        *addr = RES_BUF_SW_PAIRING_MP3;
        *len  = RES_LEN_SW_PAIRING_MP3;
        break;
    case TWS_RES_SW_CONNECTED:
        *addr = RES_BUF_SW_CONNECTED_MP3;
        *len  = RES_LEN_SW_CONNECTED_MP3;
        break;
    case TWS_RES_SW_DISCONNEC:
        *addr = RES_BUF_SW_DISCON_MP3;
        *len  = RES_LEN_SW_DISCON_MP3;
        break;
    case TWS_RES_SW_MAX_VOL:
        *addr = RES_BUF_SW_MAX_VOL_MP3;
        *len  = RES_LEN_SW_MAX_VOL_MP3;
        break;
    case TWS_RES_SW_MUSIC_MODE:
        *addr = RES_BUF_SW_MUSIC_MODE_MP3;
        *len  = RES_LEN_SW_MUSIC_MODE_MP3;
        break;
    case TWS_RES_SW_GAME_MODE:
        *addr = RES_BUF_SW_GAME_MODE_MP3;
        *len  = RES_LEN_SW_GAME_MODE_MP3;
        break;
    case TWS_RES_SW_ANC_ON:
        *addr = RES_BUF_SW_ANC_ON_MP3;
        *len  = RES_LEN_SW_ANC_ON_MP3;
        break;
    case TWS_RES_SW_ANC_OFF:
        *addr = RES_BUF_SW_ANC_OFF_MP3;
        *len  = RES_LEN_SW_ANC_OFF_MP3;
        break;
    case TWS_RES_ANC_OPEN:
        *addr = RES_BUF_OPENMODE_MP3;
        *len  = RES_LEN_OPENMODE_MP3;
        break;
    case TWS_RES_SW_LOW_BATTERY:
        *addr = RES_BUF_SW_LOWBATTERY_MP3;
        *len  = RES_LEN_SW_LOWBATTERY_MP3;
        break;
    case TWS_RES_SW_FIND_EAR:
        *addr = RES_BUF_FIND_EAR_WAV;
        *len  = RES_LEN_FIND_EAR_WAV;  
        break;  
    case TWS_RES_SW_POWER_ON:
        *addr = RES_BUF_SW_POWERON_MP3;
        *len  = RES_LEN_SW_POWERON_MP3;
        break;
#endif

...
const uint8_t cfg_a2dp_sbc_max_bitpool = 45;//45;            //设置SBC格式最大码率，默认值为53，可选值24~53（建议不低于39）
// const uint32_t cfg_a2dp_aac_max_bitrate = 256000;//128000;       //设置AAC格式最大码率，默认值为0（不限制），可选值128000, 192000, 256000,
uint16_t cfg_bt_music_normal_latency   = 180;//280;           //设置蓝牙普通模式延迟，默认值280ms，可选值100~450

...
#define KEY_LONG_TIMES          480         //长按键的次数
...
#define EVT_A2DP_SET_VOL        0x7f2       //手机端调音量
...
#define EVT_TWS_INIT_VOL        0x7db       //TWS连接上同步音量
#define EVT_TWS_SET_VOL         0x7da       //TWS按键调音量
...
#define EVT_DNC_START           0x7cf
#define EVT_DNC_STOP            0x7ce
#define EVT_DEV_SAVE_VOL        0x7cd

#define EVT_AUTO_PWFOFF_EN      0x7cc
#define EVT_AUTO_PWFOFF_DIS     0x7cb
#define EVT_IODM_TEST           0x7ca

#define EVT_A2DP_SAVE_DEV_VOL   0x7c9
#define EVT_A2DP_SYNC_CLOSE     0x7c8

#define EVT_UDE_SET_VOL         0x7c7
#define EVT_SOFT_VOL_SET        0x7c6
#define EVT_ONLINE_SET_EFFECT   0x7c5
#define EVT_ONLINE_SET_ANC_ALG  0x7c4
#define EVT_ABP_SET             0x7c3
#define EVT_ASR_START           0x7c2
#define EVT_ASR_STOP            0x7c1
#define EVT_ONLINE_SET_ANC_TOOL 0x7c0
#define EVT_ENCODE_STOP         0x7bf

#define EVT_HID_SLIDE_UP        0x7be
#define EVT_HID_SLIDE_DOWN      0x7bd
#define EVT_HID_P               0x7bc
#define EVT_HID_PP              0x7bb
#define EVT_HID_TAKE_PIC        0x7ba

#define EVT_BT_MAP_DONE         0x7b9
#define EVT_HFP_TIME_DONE       0x7b8
...
#define EVT_KEY_PRESS           0x001
#define EVT_KEY_ANC_SWITCH      0x002
#define EVT_SYS_5S              0x003
#define EVT_SPP_AT_CMD          0x004
#define EVT_IN_CASE             0x005
#define EVT_OUT_CASE            0x006
#define EVT_AUTO_ANCOFF         0x007
#define EVT_AUTO_ANCON          0x008

#define EVT_SYS_1S              0x009


#define EVT_SYS_500MS           0x010

#define EVT_FIND_DEV            0x011
#endif

#if TWS_LR
#define EVT_BAT_LEVEL_CHANGED                   0x711
#define EVT_CHECK_VERSION                       0x71d
#define EVT_PAIR_STATUS_CHANGED                 0x735
#define EVT_INBOX_CHANGED                       0x73f
#define EVT_SLAVE_KEY                           0x726
